function [filenumber,vgsQ,vdsQ,idsQ]=getfile2(dcfile,vdsQ,idsQ)

% GETFILE2(...) searches thru the DC data file to find the file numbers
% of the selected bias point defined by the values vdsQ and idsQ.
%
% Input Parameters:
%
%   dcfile          String containing the name of the DCdata.txt file
%   vdsQ            Drain source bias voltage (unit = Volt)
%   idsQ            Drain source bias current (unit = Ampere)
%
% Output Parameter:
%
...
%
% format: [filenumber,vgsQ,vdsQ,idsQ]=getfile2(dcfile,vdsQ,idsQ)
%
