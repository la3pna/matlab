function [Sx,GL,R1]=trlml(Sthru,Sopen,Sline1,Sline2,Sdut,freq,fb);
...
%    Sline1   Four colom matrix containing S-Parameters of the line measurement on
%            TRL test fixture.
...
%
% format: [Sx,GL]=trlml(Sthru,Sopen,Sline1,Sline2,Sdut,freq,fb)
%
...
S11l = [S11l ; Sline2(fi,1)];
S21l = [S21l ; Sline2(fi,2)];
S12l = [S12l ; Sline2(fi,3)];
S22l = [S22l ; Sline2(fi,4)];
...
for n = 1:nfreq
    ...
    %   GL(n) = (1/2)*log((T(2,1)*b + T(2,2))/(T(1,2)*ca + T(1,1)));
